...
from lib.base import BaseMeshBuilder, CachedMeshBuilder
from lib.builders.led import LedBuilder
from lib.factories.constants import LED_RADIUS, LED_HEIGHT, LED_ANODE_LENGTH, LED_CATHODE_LENGTH, BOARD_GRID_STEP, \
...
def create_led_builder(color: np.ndarray) -> BaseMeshBuilder:
    return CachedMeshBuilder(LedBuilder(
        radius=LED_RADIUS,
        height=LED_HEIGHT,
