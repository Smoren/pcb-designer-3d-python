...
from lib.constants import BOARD_GRID_STEP, RESISTOR_STEPS_COUNT, RESISTOR_RADIUS, WIRE_CONTACT_RADIUS, \
    RESISTOR_WIRE_BOND_RADIUS, BOARD_PAD_RADIUS, BOARD_THICKNESS, WIRE_CONTACT_TOLERANCE, \
...
def create_resistor_builder(color: np.ndarray = RESISTOR_DEFAULT_COLOR) -> BaseMeshBuilder:
    return ResistorBuilder(
        ...
        wire_vertical_length=RESISTOR_RADIUS + RESISTOR_TOLERANCE + BOARD_THICKNESS + WIRE_CONTACT_TOLERANCE,
