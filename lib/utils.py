...
def create_bounded_pipe(pipe_radius: float, bond_radius: float, vertical_length: float, horizontal_length: float):
    vertical_cylinder = trimesh.creation.cylinder(radius=pipe_radius, height=vertical_length - bond_radius, sections=128)
    horizontal_cylinder = trimesh.creation.cylinder(radius=pipe_radius, height=horizontal_length - bond_radius, sections=128)
    ...
    torus = trimesh.creation.torus(major_radius=bond_radius, minor_radius=pipe_radius, major_sections=128,
                                   minor_sections=128)
